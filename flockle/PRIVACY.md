...
We do **not** collect your location, contacts, photos, or precise device
sensors, and we do **not** use advertising or cross-app tracking SDKs.

## How your content is shown to others
Flockle is a shared game, so some content you create is shown to other players:
- Your daily **answers** contribute to the next day's guessing round. After a
  round, answers are shown grouped into popular themes, and a few example
  responses may be displayed **without your name attached**.
- Your **username, avatar, answers (once a round is over), and scores** are
  visible to people you have added as friends.

## Who we share data with (service providers)
- **Supabase** — our backend and database host, which stores your account and
...
## How long we keep it
We keep your data while your account exists. When you delete your account (see
below), your account and all associated gameplay data are permanently removed.
...
## Children
Flockle is not directed to children under 13, and we do not knowingly collect
personal information from them. If you believe a child has provided us data,
contact us and we'll delete it.

## Changes
If we change this policy, we'll update the date above and, for significant
changes, note it in the app.
